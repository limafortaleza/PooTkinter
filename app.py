...
class App: #representação da janela.
    def __init__(self):
        self.alunos = []
        self.janela = Tk()
    ...
    def limparCampos(self):
        ...
        self.cb_cursos.set("")
        self.txt_matricula.config(state=NORMAL) #habilita o campo
        self.txt_matricula.delete(0, END)#mexe nele, ou seja apaga
        self.txt_matricula.config(state=DISABLED)#desabilita novamente.
    ...
    def editarAluno(self):
        ...
        for aluno in self.alunos:
            if str(aluno.matricula) == matricula: #tem que converter para string. Se deixar sem converter vai trazer como ID e não vai funcionar o botão de editar
